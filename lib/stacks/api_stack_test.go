...
func TestApiStack(t *testing.T) {
	...
	template.ResourceCountIs(_jsii_.String("AWS::ApiGatewayV2::Route"), _jsii_.Number(6))
	template.ResourceCountIs(_jsii_.String("AWS::Lambda::Permission"), _jsii_.Number(6))
